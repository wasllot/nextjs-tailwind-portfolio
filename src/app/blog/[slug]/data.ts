export const articles: Record<string, { title: string; titleEn: string; content: string; contentEn: string; date: string }> = {
  "migrar-monolitos-legacy-arquitecturas-desacopladas": {
    ...
    contentEn: `
      ...
      <ul>
        ...
        <li><strong>Performance:</strong> Optimize queries and critical processes that were previously bottlenecks.</li>
      </ul>
  ...
  "headless-ecommerce-prestashop-frontends-reactivos": {
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>Checkout Optimizado:</strong> Al no depender de los "pasos" rígidos del CMS, podemos diseñar checkouts de una sola página (One Page Checkout) totally personalizados para maximizar la conversión.</li>
      </ul>
